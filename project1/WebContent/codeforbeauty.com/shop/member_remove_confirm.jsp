...
<% 
 ...
 String password = session.getAttribute("sessionPASSWD").toString();
...
<div style="background-color: #f4f4f7;">
	...
	<div style="width:100%; max-width:740px; margin:0 auto; text-align:center; padding-top:60px;">
		...
		<div class="login_title">회원정보변경을 위한 비밀번호를 확인</div>
      ...
      <form name="passwdCheckForm" action="<%=request.getContextPath()%>/codeforbeauty/shop/member_modify_confirm.jsp" 
		method="post" id=passwdCheckForm >
		<div style="max-width:300px; margin: 0 auto; padding-top:30px; text-align: center;">
				 ...
				 <div>
					<ul>
					   <li class="login_input">
					    ...
					    <div id="passwdMsg" class="error" style="width:700px; text-align: left;">비밀번호를 입력해 주세요.</div>		
					    <div id="passwdMsg2" class="error" style="width:700px; text-align: left;">비밀번호가 맞지 않습니다.</div>		
					   </li>
					</ul>
				 </div>		
		</div>
		...
		<div style="margin-top:60px; padding-bottom:60px;">
		   <ul>
			  <li class="login_btn_ok"><a href=javascript:completeClick(); style="color:#fff; font-size:14px; padding:14px 90px;">입력완료</a></li> <br>
...
function completeClick() {
	...
	else if($("#passwd").val()=="<%=password%>") {
		location.href='<%=request.getContextPath()%>/codeforbeauty.com/shop/member_remove_action.jsp';
		}
	else {
