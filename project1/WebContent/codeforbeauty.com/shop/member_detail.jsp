...
<div style="background-color: #f4f4f7;">
	...
	<div style="width:100%; max-width:740px; margin:0 auto; text-align:center; padding-top:60px;">
		...
		<div style="max-width:400px; margin: 0 auto; padding-top:30px; text-align: center;">
		   <ul>
			  <li>
				 <div>
					<ul>
		...
		<div style="margin-top:60px; padding-bottom:60px;">
		   <ul>
			  <li class="login_btn_ok"><a href="javascript:location.href='<%=request.getContextPath()%>/codeforbeauty.com/shop/member_modify_confirm.jsp';" style="color:#fff; font-size:14px; padding:14px 90px;">회원정보 변경</a></li> <br>
			  <li class="login_btn_ok"><a href="javascript:location.href='<%=request.getContextPath()%>/codeforbeauty.com/shop/member_remove_confirm.jsp';" style="color:#fff; font-size:14px; padding:14px 90px;">회원탈퇴</a></li>
		   <ul>
		</div>
