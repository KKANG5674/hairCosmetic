...
<!-- Mirrored from codeforbeauty.com/shop/m_cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 08:29:35 GMT -->
<head>
         ...
         <ul>
            <li>
               <div>
                  <ul>
                     <li class="sub_image">
                       <img src="../shop/skin/mall_dc/image/cart/cart_icon.png">   
                     </li>   
                  </ul>   
               </div>   
               <div>
                  <ul>
                     <li class="sub_sub_text">Cart</li>   
                  </ul>   
               </div>   
               <div>
                  <ul>
                     <li class="sub_title_text">카트에 담긴</li>
                  </ul>   
               </div>
               <div>
                  <ul>
                     <li class="sub_title_text01">주문내역을 확인하세요</li>
                  </ul>   
               </div>               
            </li>   
         </ul>   
...
<%
	...
	int count=0;
	//카트에 담긴 상품이 있는경우
	if(cartDAO.cartCheck(id)){
    
    %>
    <div style="width:100%; max-width:768px; margin:0 auto; text-align:center;">

    <form action="./cart/cartDelete.jsp" method="post" name="cartdelete" id="cartDelete">
      ...
      <div style="background:#fff; border-radius:26px; padding:22px 22px;">
         ...
         <div style="text-align:left; margin-top:30px;">
           <ul>
             ...
             <li style="color:#757575; font-size:12px; line-height:24px;"><span style="color: #4a4a4a; font-size:12px; opacity:0.6; margin-right:10px;">총금액</span> <%=list.get(count).getPrice()%></li>
             <li style="margin-top:20px;">
                <div>
                  <ul>
                     <li style="width:100%;">
                      <a href="#" onclick="document.getElementById('cartDelete').submit();" style="color:#fff; font-size:14px;"><div style="width:100%; border-radius: 16px; background:#191919; padding:12px 0px; text-align:center;">삭제</div></a>
                     </li>
                  </ul>
               </div>
             </li>
       ...
       <div style="padding:90px 0px 0px 0px; width:100%; max-width:768px; margin:0 auto;">
       
      <div class="company_b_text" style="margin-bottom:30px;">카트에 담긴상품</div>
   <!-- for문 추가 -->
   ...
   String replace = "";
    ...
    %>
         <ul>
           <li>
               <div style="font-size:14px; color: #191919; padding:7px 0px;">
               <ul>
                  <li style="float:left; width:70%; text-align:left;">고객님의 헤어케어</li>
                  <li style="float:right; width:30%; text-align:right;"><%=list.get(count).getPrice()%></li>
               <div style="clear:both;"></div>
         </ul>
            
   <%//반복동안 getPrice() 가격 더하기
   replace = list.get(count).getPrice().replaceAll("[^0-9]","");
   ...
   %>
         ...
         <!-- ---------------------------------------- -->
                  <!--토탈금액 출력하는곳 (xxxxx) -->
             <div style="border-top: solid 1.5px #efefef; margin:20px 0px 20px 0px;"></div>
                      <div style="font-weight:bold;">
               <ul>
                  <li style="float:left; width:70%; text-align:left; font-size:12px;">카트에 담긴 금액</li>
                  <li style="float:right; width:30%; font-size:20px; text-align:right;"><%=totalPrice%>원</li>
                  <div style="clear:both;"></div>
               </ul>
             </div>
           </li>
   ...
   <div style="padding:30px 0px; width:100%; max-width:330px; margin:0 auto;">
      <div>
         <ul>
           <li style="margin:0px 10px;">
              <div>
                <ul>
                  <li style="1float:left; width:100%;">
                     <div style="width:100%; border-radius: 16px; background-color: #191919; padding:12px 0px; text-align:center;"><a href="./paymentPage.jsp" style="color:#fff; font-size:14px; padding:12px 123px;">구매하기</a></div>
                  </li>
                  <div style="clear:both;"></div>
               </ul>
             </div>
             <div></div></li><li class="main_bottom_text">무료배송! 무료재조합!</li></ul></div>
    ...
    <form action="http://codeforbeauty.com/shop/m_cart_ok.php" method="post" name="cart_">
	<input type="hidden" name="ps_mode" value="change">
	<input type="hidden" name="ps_caid" value="">
	<input type="hidden" name="ps_ctid" value="">
	<input type="hidden" name="ps_reurl" value="m_cart.html">
		
	<div style="text-align:center; margin-top:80px; color: #757575; font-size:14px;">카트에 담긴 상품이 없습니다. </div>
		
	<div style="margin-top:60px;">
	   <ul>
		  <li>
			 <div style="width:220px; border-radius: 16px; background-color: #191919; padding:12px 0px; text-align:center;"><a href="javascript:orderMenuClick();" style="color:#fff; font-size:16px; padding:12px 80px">주문하기</a></div>
		  </li>
	   </ul>
	</div>
	<div><li class="main_bottom_text" style="padding-bottom:40px;">코드포뷰티의 제품이 고객님과 맞지 않을 시<br>30일 이내에 재조합하여 보내드립니다.</li></div>
...
<script language=JavaScript>
      ...
      <div id="pc" style="background-color: #191919; width:100%;">
          <ul>
              <li>
...
/* function cartDelete(){
	var cd = document.cartdelete;
	cd.action = "./cart/cartDelete.jsp";
	cd.submit();
} */
</script>
 </body>
