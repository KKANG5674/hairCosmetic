...
<script type="text/javascript">//로그인 세션 검사
	<% //세션이 null이면 
	if(session.getAttribute("sessionID")==null){%>
	<% //세션이 null이 아니면 
	}else{ %>
		location.href='./cart_ok.jsp';
	<%}%>	
</script>
 <div id="pc">
			...
			<ul>
				<li>
					<div>
						<ul>
							<li class="sub_image">
							  <img src="skin/mall_dc/image/cart/cart_icon.png">	
							</li>	
						</ul>	
					</div>	
					<div>
...
<div style="width:100%; max-width:768px; margin:0 auto; text-align:center;">
	...
	<div style="text-align:center; margin-top:80px; color: #757575; font-size:14px;">카트에 담긴 상품이 없습니다. <!-- <img src="../shop/skin/mall_dc/image/cart/cart_no.png"> --></div>
...
<!--
function cart_change(frm){
	frm.ps_mode.value = "change";
	frm.action = "m_cart_ok.html";
	frm.submit();
	return;
}

function cart_to_wish(frm){
	frm.ps_mode.value = "move_wish";
	frm.action = "m_cart_ok.html";
	frm.submit();
	return;
}
...
<!-- Mirrored from codeforbeauty.com/shop/m_cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 08:29:37 GMT -->
</html>
